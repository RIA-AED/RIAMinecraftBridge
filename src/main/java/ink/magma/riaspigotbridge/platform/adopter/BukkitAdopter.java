...
import ink.magma.riaspigotbridge.RIASpigotBridge_Bukkit;
import ink.magma.riaspigotbridge.platform.adopter.console.sender.fake.BukkitFakeCommandSender;
...
public class BukkitAdopter implements PlatformAdopter {
    ...
    public BukkitAdopter() {
        File serverFolder = RIASpigotBridge_Bukkit.instance.getServer().getWorldContainer().getParentFile();
    ...
    public File getPluginFolder() {
        return RIASpigotBridge_Bukkit.instance.getDataFolder();
    }
    ...
    public UUID dispatchCommandByWrapper(String command) {
        ...
        // 异步执行命令
        Bukkit.getScheduler().runTask(RIASpigotBridge_Bukkit.instance, () -> {
    ...
    public PlayerList getPlayerList() {
        ...
        RIASpigotBridge_Bukkit.instance.getServer().getOnlinePlayers().forEach(player -> {
    ...
    public void logInfo(String message) {
        RIASpigotBridge_Bukkit.instance.getLogger().info(message);
    }

    @Override
    public void logError(String message) {
        RIASpigotBridge_Bukkit.instance.getLogger().severe(message);
    }

    @Override
    public void logWarn(String message) {
        RIASpigotBridge_Bukkit.instance.getLogger().warning(message);
    }

    @Override
    public Collection<Plugin> getPlugins() {
        org.bukkit.plugin.Plugin[] platformPlugins = RIASpigotBridge_Bukkit.instance.getServer().getPluginManager().getPlugins();
